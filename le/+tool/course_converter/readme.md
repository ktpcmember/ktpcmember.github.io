...
- 制作者 tomolatoon
#### 内容
1. HTMLを`mainセクション`において直に埋め込める機能を追加。
...
#### 内容
1. URLを記述する機能を追加。
2. 表で`$;`を挿入した場合に改行する機能を追加。

### v2.2
- リリース 2021/07/15
- 制作者 tomolatoon
#### 内容
1. 表の要素の後にホワイトスペースがあると検出されないバグを修正
...
- 制作者 tomolatoon
#### 内容
1. mainセクションのタイトルにはテキスト処理を行っていなかったため、ルビなどが振れていなかった問題を修正
2. 隠れコードブロックにおいて、最後に改行が余分に含まれる問題を修正
...
#### 内容
1. preブロックのリクエスト部分が、app.jsのコード片になっていた（関数呼び出しをしていなかった）バグを修正
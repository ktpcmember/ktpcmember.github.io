...
### このリポジトリーをイジろうとしている後輩へ
とりあえずディレクトリーの整理までは終わりましたがパスの書き換えが本当に面倒です。ほんとに面倒。やるなら10人くらいでやるべきでしょう。それかパスを自動で書き換えてくれる画期的なAIが出てくるのを待ちましょう。UIは装飾部門のページだけ新しいバージョンにしておいたのでそれを参考にするといいかもです。
UIが気に入らなかったら全然書き換えてもいいです。ハンバーガーメニューとかを導入してもいいかも、、、
